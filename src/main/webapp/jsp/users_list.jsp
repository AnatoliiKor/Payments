...
<div class="container mt-2">
    ...
    <ul class="pagination">
        <li class="page-item ${pg == 1 ? 'disabled' : ''}"><a class="page-link" href="/users?pg=${pg-1}"><fmt:message
        ...
        <li class="page-item ${pg == pg_max? 'disabled' : ''}"><a class="page-link"
                                                                  href="/users?pg=${pg+1}"><fmt:message
                key="next_main"/></a></li>
    </ul>
    ...
    <table class="table table-striped auto__table table-condensed text-center">
        ...
        <c:choose>
            <c:when test="${not empty users}">
                <c:forEach var="user" items="${users}" varStatus="position" begin="${10 * (pg - 1)}"
                           end="${10 * (pg - 1) + 9}">
                    <tr>
