    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            ...
            <div><a class="btn btn-outline-success m-2"
                    href="/wallet/transactions?user_id=${user_auth.id}&account_type=payer"><fmt:message
                    key="payments"/></a></div>
            <div><a class="btn btn-outline-success m-2"
                    href="/wallet/transactions?user_id=${user_auth.id}&account_type=receiver"><fmt:message
                    key="inflows"/></a></div>
