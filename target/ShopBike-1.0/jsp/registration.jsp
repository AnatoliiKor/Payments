...
<div class="container mt-5">
        ...
        <form method="post" action="${pageContext.request.contextPath}/registration">
            ...
            <input class="mt-3" type="text" name="last_name" value="<c:if test="${last_name!=null}">${last_name}</c:if>" required>
            ...
            <input class="mt-3" type="number" name="phone_number" value="<c:if test="${phone_number!=null}">${phone_number}</c:if>" required>
